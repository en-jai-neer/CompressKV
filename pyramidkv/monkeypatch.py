...
from pyramidkv.llama_model import llama_attn_forward_PyramidKV,llama_attn_forward_CAM,llama_attn_forward_H2O,llama_attn_forward_SnapKV,llama_attn_forward_StreamingLLM, llama_attn_forward_Compress
...
def replace_llama(method):
    ...
    if method == "pyramidkv":
        ...
        transformers.models.llama.modeling_llama.LlamaAttention.forward = llama_attn_forward_Compress
