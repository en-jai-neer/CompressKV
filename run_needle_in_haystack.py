...
class LLMNeedleHaystackTester:
    ...
    def __init__(self,
        ...
        if(self.model_provider in ["LLaMA3", "Mistral"]):
            ...
            if self.method in ["pyramidkv", "snapkv","streamingllm","h2o","cam", "compress"]:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--method', type=str, default="full", choices=['full', 'pyramidkv', 'snapkv', 'streamingllm', 'h2o', 'cam', 'compress'])
